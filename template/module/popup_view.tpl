      ...
      <div class="col-sm-7">
        ...
        <ul class="thumbnails">
          ...
          <?php if ($popup_view_data['additional_image'] && $images) { ?>
            ...
            <div>
              <a href="<?php echo $image['popup']; ?>" class="sub_images">
          ...
          $(document).on('click', '.sub_images', function(e) {
	        var srci = $(this).attr("href");
            $('#popup-main-image').attr('src',srci);
            e.preventDefault();
			e.stopPropagation();
          });
          $(document).ready(function(){
			  $('.image-additional-carousel').owlCarousel({
		        ...
		        responsive:{
		            0:{
		                items:3,
		                nav:<?php if(count($images) > 3) { echo "true"; } else { echo "false"; } ?>
		            },
		            600:{
		                items:3,
		                nav:<?php if(count($images) > 3) { echo "true"; } else { echo "false"; } ?>
